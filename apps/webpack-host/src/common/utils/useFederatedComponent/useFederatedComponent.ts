...
registerRemotes([
  // { name: 'mf_books', entry: 'http://localhost:3001/remoteEntry.js', type: RemoteBundleTypes.Module }, // <--- already defined at build
  { name: 'mf_dragons', entry: 'http://localhost:3002/remoteEntry.js', type: RemoteBundleTypes.Module },
